            ...
            <div class="group relative overflow-hidden bg-white rounded-2xl p-8 border-l-4 border-teal-500 card-shadow">
                ...
                <div class="relative flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-4xl font-bold mb-3 text-gray-800">{{ $patientsCount }}</p>
            ...
            <div class="group relative overflow-hidden bg-white rounded-2xl p-8 border-l-4 border-blue-500 card-shadow">
                ...
                <div class="relative flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-4xl font-bold mb-3 text-gray-800">{{ $appointmentsCount }}</p>
                        <div class="flex items-center text-sm text-gray-600">
                        ...
                        <td class="px-8 py-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xs text-gray-500"> @if($user->role == 'admin') 
                                ...
                                @else 
                                    <span class="mr-1">👤</span> {{ ucfirst($user->role) }} 
                                @endif</div>
                                </div>
                            </div>
                        </td>
