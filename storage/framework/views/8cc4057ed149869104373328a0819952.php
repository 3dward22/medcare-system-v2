    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-lg">
            ...
            <?php if(session('error')): ?>
                <div class="text-red-600 mb-2"><?php echo e(session('error')); ?></div>
            <?php endif; ?>

            <form action="<?php echo e(route('otp.verify.post')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\med\resources\views/auth/otp.blade.php ENDPATH**/ ?>