    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center text-white font-bold text-lg">
                ...
                <div class="hidden sm:flex sm:space-x-6 sm:ml-10">
                    <a href="<?php echo e(route('dashboard')); ?>" class="text-white hover:text-gray-200 font-medium">
                        Dashboard
                    </a>
                    <?php if($appointmentsRoute): ?>
                        <a href="<?php echo e($appointmentsRoute); ?>" class="text-white hover:text-gray-200 font-medium">
                            Appointments
                        </a>
                    <?php endif; ?>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('dashboard'),'class' => 'text-white text-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('dashboard')),'class' => 'text-white text-sm']); ?>
                Dashboard
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($appointmentsRoute),'class' => 'text-white text-sm']); ?>
                    Appointments
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald69b52d99510f1e7cd3d80070b28ca18)): ?>
...
<?php /**PATH C:\xampp\htdocs\med\resources\views\layouts\navigation.blade.php ENDPATH**/ ?>